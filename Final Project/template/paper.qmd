...
@tbl-replication shows the main results of the Lei & Zhou original regression, which shows a statistically significant positive effect between a mayor securing an approval for Subway infrastructure and promotion of that mayor in 3 years. 
...
@tbl-extension further expands this effect to include the effect of age categories and mayor's tenure.

|                         |
|:------------------------|
| ![](tables\did_extension.png) |

: Replication of Lei & Zhou Difference in Difference design {#tbl-extension}
